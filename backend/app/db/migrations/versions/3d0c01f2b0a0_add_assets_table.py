...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_zones_floor_plan_id'), 'zones', ['floor_plan_id'], unique=False)
    ...
    op.create_index(op.f('ix_access_points_floor_plan_id'), 'access_points', ['floor_plan_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_access_points_floor_plan_id'), table_name='access_points')
    op.drop_table('access_points')
    op.drop_index(op.f('ix_zones_floor_plan_id'), table_name='zones')
    op.drop_table('zones')
